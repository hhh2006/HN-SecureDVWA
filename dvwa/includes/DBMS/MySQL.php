...
// SecureDVWA security telemetry table (non-sensitive event metadata only)
$create_security_events = "CREATE TABLE IF NOT EXISTS security_events (
...
if( !mysqli_query($GLOBALS["___mysqli_ston"], $create_security_events) ) {
    dvwaMessagePush( "Could not create security_events table<br />SQL: " . mysqli_error($GLOBALS["___mysqli_ston"]) );
    dvwaPageReload();
}
dvwaMessagePush( "'security_events' table was created/verified." );
$create_security_operations = "CREATE TABLE IF NOT EXISTS security_operations (
    id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
    event_time DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
if( !mysqli_query($GLOBALS["___mysqli_ston"], $create_security_operations) ) {
    dvwaMessagePush( "Could not create security_operations table<br />SQL: " . mysqli_error($GLOBALS["___mysqli_ston"]) );
    dvwaPageReload();
}
dvwaMessagePush( "'security_operations' table was created/verified." );
